            ...
            <div className="relative bg-white rounded-lg overflow-hidden shadow-xl max-w-md">
              <div className="px-6 py-4">
                <div className="flex">
                  ...
                  <h3 className="px-2 text-xl font-semobold text-gray-950">Delete Recipe</h3>
                </div>
                <div className="mt-3">
                  <p className="px-2 text-base text-gray-700">Are you sure you want to delete this recipe?</p>
                </div>
              </div>
              <div className="px-6 py-4 bg-gray-50 flex justify-end">
                ...
                <button
                  ...
                  className="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-red-500 border border-transparent rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                >
                  Delete
                </button>
              </div>
